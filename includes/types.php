...
?>
<div class="h5 mb-3">Active categories (post)</div>
<?php
foreach ($categories as $category) {
    $checked = isset($discordance_opts['categories']) ? (in_array($category->term_id, $discordance_opts['categories']) ? " checked" : "") : " checked";
    echo <<<HTML
<div class="form-check d-flex align-items-center p-0 mb-2">
